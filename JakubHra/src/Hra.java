 ...
 * tøída hra by v sobì nemìla mít combat, combat a s ním spojené vykreslování by mìla být vlastní tøída volána støídou hra když v dungeonu narazíš na nepøátele
 * (pokud tam ten dungeon bude)
 * všechni hrdinové a nepøátelé dìdí z postavy
 * postavy se inicializují na zaèátku boje a mají svoje pozice podle kterých se nìjak urèuje na koho míøí útoky, ještì nevím jak
 * už jsem dnes líný a posílám ti tento polotovar
 */
